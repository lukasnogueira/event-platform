...
export function Subscribe() {
    ...
    const [createSubscriber] = useMutation(CREAT_SUBS_MUTATION)
             ...
             max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
                <div className="max-w-[640px]">
                    ...
                    <h1 className="mt-8 text-[2.5rem] leading-tight">
                        construa uma <strong className="text-blue-400">aplicação completa</strong>, do zero, com <strong className="text-blue-400">React</strong>
                    </h1>
